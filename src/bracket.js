...
export const DEFAULT_FOODS = [
  ...
  { id: 2,  name: "Shake Shack",       emoji: '🍔', division: 'burger'   },
  { id: 3,  name: "Five Guys",         emoji: '🍔', division: 'burger'   },
  { id: 4,  name: "Wendy's",           emoji: '🍔', division: 'burger'   },
  { id: 5,  name: "Burger King",       emoji: '🍔', division: 'burger'   },
  { id: 6,  name: "Whataburger",       emoji: '🍔', division: 'burger'   },
  { id: 7,  name: "McDonald's",        emoji: '🍔', division: 'burger'   },
  { id: 8,  name: "Culver's",          emoji: '🍔', division: 'burger'   },
  // Cluckers Conference — chicken & wings
  { id: 9,  name: "Chick-fil-A",       emoji: '🐔', division: 'chicken'  },
  { id: 10, name: "Popeyes",           emoji: '🍗', division: 'chicken'  },
  { id: 11, name: "Raising Cane's",    emoji: '🍗', division: 'chicken'  },
  { id: 12, name: "KFC",               emoji: '🍗', division: 'chicken'  },
  { id: 13, name: "Wingstop",          emoji: '🍗', division: 'chicken'  },
  { id: 14, name: "Buffalo Wild Wings",emoji: '🍗', division: 'chicken'  },
  { id: 15, name: "Jack in the Box",   emoji: '🍔', division: 'chicken'  },
  { id: 16, name: "Panda Express",     emoji: '🥡', division: 'chicken'  },
  // Handheld Heroes — grab-and-go
  { id: 17, name: "Chipotle",          emoji: '🌯', division: 'handheld' },
  { id: 18, name: "Taco Bell",         emoji: '🌮', division: 'handheld' },
  { id: 19, name: "Subway",            emoji: '🥪', division: 'handheld' },
  { id: 20, name: "Jersey Mike's",     emoji: '🥪', division: 'handheld' },
  { id: 21, name: "Qdoba",             emoji: '🌯', division: 'handheld' },
  { id: 22, name: "Panera Bread",      emoji: '🥐', division: 'handheld' },
  { id: 23, name: "Domino's",          emoji: '🍕', division: 'handheld' },
  { id: 24, name: "Papa John's",       emoji: '🍕', division: 'handheld' },
  // Sit-Down Showdown — casual dining
  { id: 25, name: "Olive Garden",      emoji: '🍝', division: 'sitdown'  },
  { id: 26, name: "Cheesecake Factory",emoji: '🍰', division: 'sitdown'  },
  { id: 27, name: "Texas Roadhouse",   emoji: '🥩', division: 'sitdown'  },
  { id: 28, name: "Applebee's",        emoji: '🍺', division: 'sitdown'  },
  { id: 29, name: "Chili's",           emoji: '🌶️', division: 'sitdown'  },
  { id: 30, name: "IHOP",              emoji: '🥞', division: 'sitdown'  },
  { id: 31, name: "Waffle House",      emoji: '🧇', division: 'sitdown'  },
  { id: 32, name: "Pizza Hut",         emoji: '🍕', division: 'sitdown'  },
]
